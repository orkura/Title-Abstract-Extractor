...
用于在论文详情页自动提取题目和摘要的浏览器插件，支持 IEEE Xplore、ScienceDirect，并包含 SpringerLink、ACM Digital Library 和通用网页元数据兜底规则。
...
- 点击浏览器工具栏中的插件图标，弹窗会自动显示题目和摘要。
- 可复制题目、复制摘要、复制全部、导出 TXT，或打开页面浮窗。
